<div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition">
    ...
    {{-- Make whole card clickable (optional). Wrap with a form for quick add: --}}
        <button data-id="{{ $item['id'] }}" type="button" class="cart-add w-full text-center text-sm text-gray-600 hover:text-emerald-700 py-2 border-t">Click card to add</button>
</div>
